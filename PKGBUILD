...
# patches
_patches=('better_default_resolution' 'faster_gamebar_pagination' 'menu_render_worldlist_optim' 'minetest_discord_rpc' 'no_gradient_buttons' 'remove_topleft_game_text' 'suppress-dirty-version')
